...
export function activate(context: vscode.ExtensionContext) {
    ...
    const registerCommand = (command: string, cb: (...args0: any[]) => unknown) => {
        vscode.commands.registerCommand(command, (...args) => {
            try {
                cb(...args)
            } catch(e) {
                if (e instanceof Error) {
                    extension.logger.logError(e)
                }
                throw e
            }
        })
    ...
    registerCommand('latex-workshop.saveWithoutBuilding', () => extension.commander.saveWithoutBuilding())
    registerCommand('latex-workshop.build', () => extension.commander.build())
    registerCommand('latex-workshop.recipes', (recipe) => extension.commander.recipes(recipe))
    registerCommand('latex-workshop.view', (mode) => extension.commander.view(mode))
    registerCommand('latex-workshop.refresh-viewer', () => extension.commander.refresh())
    registerCommand('latex-workshop.tab', () => extension.commander.view('tab'))
    registerCommand('latex-workshop.kill', () => extension.commander.kill())
    registerCommand('latex-workshop.synctex', () => extension.commander.synctex())
    registerCommand('latex-workshop.texdoc', (pkg) => extension.commander.texdoc(pkg))
    registerCommand('latex-workshop.texdocUsepackages', () => extension.commander.texdocUsepackages())
    registerCommand('latex-workshop.synctexto', (line, filePath) => extension.commander.synctexonref(line, filePath))
    registerCommand('latex-workshop.clean', () => extension.commander.clean())
    registerCommand('latex-workshop.actions', () => extension.commander.actions())
    registerCommand('latex-workshop.citation', () => extension.commander.citation())
    registerCommand('latex-workshop.addtexroot', () => extension.commander.addTexRoot())
    registerCommand('latex-workshop.wordcount', () => extension.commander.wordcount())
    registerCommand('latex-workshop.log', (compiler) => extension.commander.log(compiler))
    registerCommand('latex-workshop.code-action', (d, r, c, m) => extension.codeActions.runCodeAction(d, r, c, m))
    registerCommand('latex-workshop.goto-section', (filePath, lineNumber) => extension.commander.gotoSection(filePath, lineNumber))
    registerCommand('latex-workshop.navigate-envpair', () => extension.commander.navigateToEnvPair())
    registerCommand('latex-workshop.select-envname', () => extension.commander.selectEnvName())
    registerCommand('latex-workshop.multicursor-envname', () => extension.commander.multiCursorEnvName())
    registerCommand('latex-workshop.toggle-equation-envname', () => extension.commander.toggleEquationEnv())
    registerCommand('latex-workshop.close-env', () => extension.commander.closeEnv())
    registerCommand('latex-workshop.wrap-env', () => extension.commander.insertSnippet('wrapEnv'))
    registerCommand('latex-workshop.onEnterKey', () => extension.commander.onEnterKey())
    registerCommand('latex-workshop.onAltEnterKey', () => extension.commander.onEnterKey('alt'))
    registerCommand('latex-workshop.revealOutputDir', () => extension.commander.revealOutputDir())
    registerCommand('latex-workshop-dev.parselog', () => extension.commander.devParseLog())
    registerCommand('latex-workshop-dev.parsetex', () => extension.commander.devParseTeX())
    registerCommand('latex-workshop-dev.parsebib', () => extension.commander.devParseBib())

    registerCommand('latex-workshop.shortcut.item', () => extension.commander.insertSnippet('item'))
    registerCommand('latex-workshop.shortcut.emph', () => extension.commander.toggleSelectedKeyword('emph'))
    registerCommand('latex-workshop.shortcut.textbf', () => extension.commander.toggleSelectedKeyword('textbf'))
    registerCommand('latex-workshop.shortcut.textit', () => extension.commander.toggleSelectedKeyword('textit'))
    registerCommand('latex-workshop.shortcut.underline', () => extension.commander.toggleSelectedKeyword('underline'))
    registerCommand('latex-workshop.shortcut.textrm', () => extension.commander.toggleSelectedKeyword('textrm'))
    registerCommand('latex-workshop.shortcut.texttt', () => extension.commander.toggleSelectedKeyword('texttt'))
    registerCommand('latex-workshop.shortcut.textsl', () => extension.commander.toggleSelectedKeyword('textsl'))
    registerCommand('latex-workshop.shortcut.textsc', () => extension.commander.toggleSelectedKeyword('textsc'))
    registerCommand('latex-workshop.shortcut.textnormal', () => extension.commander.toggleSelectedKeyword('textnormal'))
    registerCommand('latex-workshop.shortcut.textsuperscript', () => extension.commander.toggleSelectedKeyword('textsuperscript'))
    registerCommand('latex-workshop.shortcut.textsubscript', () => extension.commander.toggleSelectedKeyword('textsubscript'))
    registerCommand('latex-workshop.shortcut.mathbf', () => extension.commander.toggleSelectedKeyword('mathbf'))
    registerCommand('latex-workshop.shortcut.mathit', () => extension.commander.toggleSelectedKeyword('mathit'))
    registerCommand('latex-workshop.shortcut.mathrm', () => extension.commander.toggleSelectedKeyword('mathrm'))
    registerCommand('latex-workshop.shortcut.mathtt', () => extension.commander.toggleSelectedKeyword('mathtt'))
    registerCommand('latex-workshop.shortcut.mathsf', () => extension.commander.toggleSelectedKeyword('mathsf'))
    registerCommand('latex-workshop.shortcut.mathbb', () => extension.commander.toggleSelectedKeyword('mathbb'))
    registerCommand('latex-workshop.shortcut.mathcal', () => extension.commander.toggleSelectedKeyword('mathcal'))
    registerCommand('latex-workshop.surround', () => extension.completer.command.surround())

    registerCommand('latex-workshop.promote-sectioning', () => extension.commander.shiftSectioningLevel('promote'))
    registerCommand('latex-workshop.demote-sectioning', () => extension.commander.shiftSectioningLevel('demote'))

    registerCommand('latex-workshop.showCompilationPanel', () => extension.buildInfo.showPanel())
    registerCommand('latex-workshop.showSnippetPanel', () => extension.snippetPanel.showPanel())

    registerCommand('latex-workshop.bibsort', () => extension.bibtexFormater.bibtexFormat(true, false))
    registerCommand('latex-workshop.bibalign', () => extension.bibtexFormater.bibtexFormat(false, true))
    registerCommand('latex-workshop.bibalignsort', () => extension.bibtexFormater.bibtexFormat(true, true))
