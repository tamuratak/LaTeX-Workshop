...
export class Extension {
    ...
    constructor() {
        ...
        this.logger.addLogMessage(`$PERL5LIB: ${process.env.PERL5LIB}`)
        this.logger.addLogMessage(`$PERLLIB: ${process.env.PERLLIB}`)
        this.logger.addLogMessage(`$PAR_GLOBAL_TEMP: ${process.env.PAR_GLOBAL_TEMP}`)
